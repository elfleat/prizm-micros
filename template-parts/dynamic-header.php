...
<div class="site-header-container">
	<header id="site-header" class="site-header dynamic-header <?php echo esc_attr($header_class); ?>">
		<div class="text-center p-2 w-full" style="background: #ff00de;">
			<div class="text-white">
				LEGAL IN ALL 50 STATES | Free Shipping on orders of $ 69.99 or more!
			</div>
		</div>
		<div class="header-container w-full py-4">
			<div class="header-inner">
				...
				<?php endif; ?>
				<div class="side-menu">
					<a href="<?= bloginfo('url') ?>/cart/" class="shopping-cart-link">
						<?php
						$productsInCart = WC()->cart->get_cart_contents_count();

						if ($productsInCart > 0) {
						?>
							<span class="products-in-cart"><?= $productsInCart ?></span>
						<?php
						}
						?>
						<i class="ph-light ph-handbag"></i>
					</a>
					<a href="<?= bloginfo('url') ?>/my-account/" class="account-link">
